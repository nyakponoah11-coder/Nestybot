...
/*
 EDIT ME — each price (₵1 through ₵30) has its own 5
...
/* =========================================================
 ...
 {"type":"netflix"} before payment, then
 {"type":"netflix","paidAt":"2026-08-10T12:00:00.000Z"}
 after payment — paidAt lets us ignore any old Netflix
 emails already sitting in the inbox before this order.
========================================================= */
...
━━━━━━━━━━━━━━━━
 ...
 Estimated delivery time: ${tracker.estimatedTime} `;
...
Reply YES to pay or NO to cancel`
 ...
 /* =====================================================
 STEP 53 - NETFLIX: AWAITING "GET CODE" REQUEST
 ===================================================== */
...
Customer: ${session.phone}`
 ...
 return sendWhatsApp(
 from,
 " We're finalizing your sign-in approval, this should complete shortly. Reply GET CODE again in a minute if you don't see it go through."
 );
 }
 ...
 return sendWhatsApp(
 from,
 " We could not check the email right now. Please reply GET CODE again in a moment, or contact 0547100951 (@stony11) for help."
 );
 }
...
Make sure you've chosen "Sign in" on Netflix using ${NETFLIX_EMAIL}, then reply GET CODE again in a moment.`
 );
 }

 return sendWhatsApp(
 from,
 `Reply GET CODE once you've requested sign-in on Netflix, or reply HI to return to the menu.`
 );
 }
