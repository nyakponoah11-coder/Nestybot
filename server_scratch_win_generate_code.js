...
Reply *GENERATE 1* and the system will generate your unique code automatically.
...
if (scratch.scratched || scratch.status === "used") return sendWhatsApp(from, "🎟️ This Scratch Card has already been used. Reply *GENERATE 1* to start a new challenge.");
...
return sendWhatsApp(from, "❌ We could not generate your Scratch Code right now. Please try again.");
}
}
...
campaign_code:
session.scratch_order_opt_in ? session.scratch_code : null
}
